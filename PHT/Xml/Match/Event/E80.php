...
class E80 extends Xml\Match\Event
{
    /**
     * Return event name
     *
     ...
     */
    public function getOldCaptain()
    {
        if ($this->type == Config\Config::MATCH_YOUTH) {
            return Wrapper\Player\Youth::player($this->getOldCaptainId());
        }
        return Wrapper\Player\Senior::player($this->getOldCaptainId());
    }
     ...
     * @return \PHT\Xml\Player\Senior|\PHT\Xml\Player\Youth
     */
    public function getNewCaptain()
    {
        if ($this->type == Config\Config::MATCH_YOUTH) {
            return Wrapper\Player\Youth::player($this->getNewCaptainId());
        }
        return Wrapper\Player\Senior::player($this->getNewCaptainId());
    }
}
