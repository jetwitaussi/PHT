...
class E81 extends Xml\Match\Event
{
    /**
     * Return event name
     *
     ...
     * @return integer
     */
    public function getOldSetPiecesTakerId()
    {
     ...
     */
    public function getOldSetPiecesTaker()
    {
        if ($this->type == Config\Config::MATCH_YOUTH) {
            return Wrapper\Player\Youth::player($this->getOldSetPiecesTakerId());
        }
        return Wrapper\Player\Senior::player($this->getOldSetPiecesTakerId());
    }
     ...
     * @return integer
     */
    public function getNewSetPiecesTakerId()
    {
     ...
     * @return \PHT\Xml\Player\Senior|\PHT\Xml\Player\Youth
     */
    public function getNewSetPiecesTaker()
    {
        if ($this->type == Config\Config::MATCH_YOUTH) {
            return Wrapper\Player\Youth::player($this->getNewSetPiecesTakerId());
        }
        return Wrapper\Player\Senior::player($this->getNewSetPiecesTakerId());
    }
}
